package com.team.forapps.oauth.service;

import com.team.forapps.oauth.dto.UserSession;
import com.team.forapps.oauth.exception.OAuth2EmailNotFoundException;
import com.team.forapps.oauth.support.OAuthAttributes;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public User createAndSaveUser(OAuthAttributes attributes) {
        User createUser = User.createUser(attributes.getEmail());
